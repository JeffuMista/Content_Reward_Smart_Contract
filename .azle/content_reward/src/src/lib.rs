...
struct StableBTreeMap0ValueType(Entry);
impl CdkActTryIntoVmValue<&mut boa_engine::Context<'_>, boa_engine::JsValue>
...
#[ic_cdk_macros::query(name = "readEntry")]
#[candid::candid_method(query, rename = "readEntry")]
async fn _cdk_user_defined_readEntry(
    _cdk_user_defined_id: String,
) -> (_AzleResult<Entry, String>) {
    BOA_CONTEXT_REF_CELL
        .with(|box_context_ref_cell| {
            let mut boa_context = box_context_ref_cell.borrow_mut();
            let uuid = uuid::Uuid::new_v4().to_string();
            ...
            METHOD_NAME_REF_CELL
                .with(|method_name_ref_cell| {
                    let mut method_name_mut = method_name_ref_cell.borrow_mut();
                    *method_name_mut = "readEntry".to_string();
                });
            MANUAL_REF_CELL
                .with(|manual_ref_cell| {
                    let mut manual_mut = manual_ref_cell.borrow_mut();
...
#[ic_cdk_macros::query(name = "getEntriesWithRewards")]
#[candid::candid_method(query, rename = "getEntriesWithRewards")]
async fn _cdk_user_defined_getEntriesWithRewards() -> (_AzleResult<Vec<Entry>, String>) {
    BOA_CONTEXT_REF_CELL
        .with(|box_context_ref_cell| {
            let mut boa_context = box_context_ref_cell.borrow_mut();
            let uuid = uuid::Uuid::new_v4().to_string();
            ...
            METHOD_NAME_REF_CELL
                .with(|method_name_ref_cell| {
                    let mut method_name_mut = method_name_ref_cell.borrow_mut();
                    *method_name_mut = "getEntriesWithRewards".to_string();
                });
            MANUAL_REF_CELL
                .with(|manual_ref_cell| {
                    let mut manual_mut = manual_ref_cell.borrow_mut();
            ...
            let exports_js_object = exports_js_value.as_object().unwrap();
            let function_js_value = exports_js_object
                .get("getEntriesWithRewards", &mut boa_context)
                .unwrap();
            let function_js_object = function_js_value.as_object().unwrap();
            let boa_return_value = unwrap_boa_result(
                function_js_object
...
#[ic_cdk_macros::query(name = "getRedeemableRewards")]
#[candid::candid_method(query, rename = "getRedeemableRewards")]
async fn _cdk_user_defined_getRedeemableRewards(
    _cdk_user_defined_rewardPoints: String,
) -> (_AzleResult<Entry, String>) {
    BOA_CONTEXT_REF_CELL
        .with(|box_context_ref_cell| {
            let mut boa_context = box_context_ref_cell.borrow_mut();
            ...
            METHOD_NAME_REF_CELL
                .with(|method_name_ref_cell| {
                    let mut method_name_mut = method_name_ref_cell.borrow_mut();
                    *method_name_mut = "getRedeemableRewards".to_string();
                });
            MANUAL_REF_CELL
                .with(|manual_ref_cell| {
                    let mut manual_mut = manual_ref_cell.borrow_mut();
            ...
            let exports_js_object = exports_js_value.as_object().unwrap();
            let function_js_value = exports_js_object
                .get("getRedeemableRewards", &mut boa_context)
                .unwrap();
            let function_js_object = function_js_value.as_object().unwrap();
            let boa_return_value = unwrap_boa_result(
                function_js_object
                    .call(
                        &boa_engine::JsValue::Null,
                        &[
                            _cdk_user_defined_rewardPoints
                                .try_into_vm_value(&mut boa_context)
                                .unwrap(),
                        ],
                        &mut boa_context,
...
#[ic_cdk_macros::update(name = "createEntry")]
#[candid::candid_method(update, rename = "createEntry")]
async fn _cdk_user_defined_createEntry(
    _cdk_user_defined_title: String,
    _cdk_user_defined_body: String,
    _cdk_user_defined_author: String,
    _cdk_user_defined_action: String,
    _cdk_user_defined_rewardPoints: _CdkFloat64,
) -> (_AzleResult<Entry, String>) {
    BOA_CONTEXT_REF_CELL
        .with(|box_context_ref_cell| {
            let mut boa_context = box_context_ref_cell.borrow_mut();
            ...
            METHOD_NAME_REF_CELL
                .with(|method_name_ref_cell| {
                    let mut method_name_mut = method_name_ref_cell.borrow_mut();
                    *method_name_mut = "createEntry".to_string();
                });
            MANUAL_REF_CELL
                .with(|manual_ref_cell| {
                    let mut manual_mut = manual_ref_cell.borrow_mut();
            ...
            let exports_js_object = exports_js_value.as_object().unwrap();
            let function_js_value = exports_js_object
                .get("createEntry", &mut boa_context)
                .unwrap();
            let function_js_object = function_js_value.as_object().unwrap();
            let boa_return_value = unwrap_boa_result(
                function_js_object
                    .call(
                        ...
                        &[
                            _cdk_user_defined_title
                                .try_into_vm_value(&mut boa_context)
                                .unwrap(),
                            _cdk_user_defined_body
                                .try_into_vm_value(&mut boa_context)
                                .unwrap(),
                            _cdk_user_defined_author
                                .try_into_vm_value(&mut boa_context)
                                .unwrap(),
                            _cdk_user_defined_action
                                .try_into_vm_value(&mut boa_context)
                                .unwrap(),
                            _cdk_user_defined_rewardPoints
                                .try_into_vm_value(&mut boa_context)
...
#[ic_cdk_macros::update(name = "updateEntry")]
#[candid::candid_method(update, rename = "updateEntry")]
async fn _cdk_user_defined_updateEntry(
    _cdk_user_defined_id: String,
    _cdk_user_defined_payload: EntryPayload,
) -> (_AzleResult<Entry, String>) {
    BOA_CONTEXT_REF_CELL
        .with(|box_context_ref_cell| {
            let mut boa_context = box_context_ref_cell.borrow_mut();
            ...
            METHOD_NAME_REF_CELL
                .with(|method_name_ref_cell| {
                    let mut method_name_mut = method_name_ref_cell.borrow_mut();
                    *method_name_mut = "updateEntry".to_string();
                });
            MANUAL_REF_CELL
                .with(|manual_ref_cell| {
                    let mut manual_mut = manual_ref_cell.borrow_mut();
            ...
            let exports_js_object = exports_js_value.as_object().unwrap();
            let function_js_value = exports_js_object
                .get("updateEntry", &mut boa_context)
                .unwrap();
            let function_js_object = function_js_value.as_object().unwrap();
            let boa_return_value = unwrap_boa_result(
                function_js_object
...
#[ic_cdk_macros::update(name = "deleteEntry")]
#[candid::candid_method(update, rename = "deleteEntry")]
async fn _cdk_user_defined_deleteEntry(
    _cdk_user_defined_id: String,
) -> (_AzleResult<Entry, String>) {
    BOA_CONTEXT_REF_CELL
        .with(|box_context_ref_cell| {
            ...
            METHOD_NAME_REF_CELL
                .with(|method_name_ref_cell| {
                    let mut method_name_mut = method_name_ref_cell.borrow_mut();
                    *method_name_mut = "deleteEntry".to_string();
                });
            MANUAL_REF_CELL
                .with(|manual_ref_cell| {
                    let mut manual_mut = manual_ref_cell.borrow_mut();
            ...
            let exports_js_object = exports_js_value.as_object().unwrap();
            let function_js_value = exports_js_object
                .get("deleteEntry", &mut boa_context)
                .unwrap();
            let function_js_object = function_js_value.as_object().unwrap();
            let boa_return_value = unwrap_boa_result(
                function_js_object
...
struct RedeemableRewardPayload {
    title: Box<String>,
    action: Box<String>,

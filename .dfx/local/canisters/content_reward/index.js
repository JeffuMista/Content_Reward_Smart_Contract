...
import { idlFactory } from './content_reward.did.js';
export { idlFactory } from './content_reward.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CONTENT_REWARD_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./content_reward.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the content_reward canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./content_reward.did.js")._SERVICE>}
 */
export const content_reward = createActor(canisterId);
